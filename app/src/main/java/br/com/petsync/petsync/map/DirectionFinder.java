...
public class DirectionFinder {
    ...
    private static final String GOOGLE_API_KEY = "AIzaSyD2wiz3r6pWw28IIWi9AH4tqd56MVXzJbg";
    ...
    public void execute() throws UnsupportedEncodingException {
        ...
        new DownloadRayData().execute(createUrl());
    }
    ...
    private class DownloadRayData extends AsyncTask<String, Void, String> {
